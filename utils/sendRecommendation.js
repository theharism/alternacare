...
async function sendReccomendationViaMail(receiverEmail, cleanseRecommendation) {
                  ...
                  <table class="main-table" width="600" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;">
                              ...
                              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                      <td valign="top" align="center" style="padding: 36px 15px 30px">
                                          <a href="#" style="display: inline-block; border: 0; text-decoration: none;"><img alt="alternacareinc" src="logo.webp" width="256" height="64" style="display: block;" vspace="0" hspace="0" border="0"></a>
                                      </td>
                                  </tr>
                              </table>
                          </td>
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                  <td style="font-family: Arial; font-size: 13px; line-height: 15px; font-weight: bold; text-transform: capitalize;">
                                                      <a href="#" style="border: 0; text-decoration: none; color: #fff;">Home</a>
                                                  </td>
                                                  <td width="19"></td>
                                                  <td style="font-family: Arial; font-size: 13px; line-height: 15px; font-weight: bold; text-transform: capitalize;">
                                                      <a href="#" style="border: 0; text-decoration: none; color: #fff;">Produts</a>
                                                  </td>
                                                  <td width="19"></td>
                                                  <td style="font-family: Arial; font-size: 13px; line-height: 15px; font-weight: bold; text-transform: capitalize;">
                                                      <a href="#" style="border: 0; text-decoration: none; color: #fff;">Dr Rob's Favorites</a>
                                                  </td>
                                                  <td width="19"></td>
                                                  <td style="font-family: Arial; font-size: 13px; line-height: 15px; font-weight: bold; text-transform: capitalize;">
                                                      <a href="#" style="border: 0; text-decoration: none; color: #fff;">Cleansing Protocols</a>
                                                  </td>
                                                  <td width="19"></td>
                                                  <td style="font-family: Arial; font-size: 13px; line-height: 15px; font-weight: bold; text-transform: capitalize;">
                                                      <a href="#" style="border: 0; text-decoration: none; color: #fff;">About Us</a>
                                                  </td>
                                                  <td width="19"></td>
                                                  <td style="font-family: Arial; font-size: 13px; line-height: 15px; font-weight: bold; text-transform: capitalize;">
                                                      <a href="#" style="border: 0; text-decoration: none; color: #fff;">Contact</a>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
                      ...
                      <tr>
                          <td valign="top" height="382">
                              <img alt="image" src="banner.webp" width="100%" style="display: block;" vspace="0" hspace="0" border="0">
                          </td>
                      </tr>
                      <tr>
                              ...
                              <table class="table-width" width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                      <td valign="top" width="252" style="padding: 50px 0 0 30px;">
                                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                              <tr>
                                                  <td style="font-weight: 700; font-size: 37px; line-height: 38px; color: #003466; font-family: Arial, sans-serif;"><span style="display: block; margin: 0 -20px 0 0;">International<br> VISW Reels</span></td>
                                              </tr>
                                              <tr>
                                      ...
                                      <td valign="top" width="348">
                                          <img alt="image" src="prod.webp" width="348" style="display: block;" vspace="0" hspace="0" border="0">
                                      </td>
                                  </tr>
                              </table>
                          </td>
                              ...
                              <table class="table-width" width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                      <td valign="top" width="355">
                                          <img alt="image" src="prod.webp" width="355" style="display: block;" vspace="0" hspace="0" border="0">
                                      </td>
                                              ...
                                              <tr>
                                                  <td valign="top" width="33%">
                                                      ...
                                                      <ul style="font-size: 11px; line-height: 24px; font-weight: 400; font-family: 'Mulish', sans-serif; color: #000000; text-transform: capitalize; display: block; margin: 0 0 10px; padding: 0; list-style: none;">
                                                          <li><a href="#" style="text-decoration: none; color: #000000">About Us</a></li>
                                                          <li><a href="#" style="text-decoration: none; color: #000000">Privacy Policy</a>
                                                          <li><a href="#" style="text-decoration: none; color: #000000">Shipping Policy</a>
                                                          <li><a href="#" style="text-decoration: none; color: #000000">Returns/Refunds Policy</a>
                                                          <li><a href="#" style="text-decoration: none; color: #000000">Terms and Conditions</a>
                                                      </ul>
                                                  </td>
                                                  <td valign="top" width="33%">
                                                          ...
                                                          <tr>
                                                              <td width="17">
                                                                  <a href="#" style="display: block; border: 0; text-decoration: none; width: 17px;">
                                                                      <img src="facebook.png" width="17" style="display: block;" vspace="0" hspace="0" border="0" alt="icon">
                                                                  </a>
                                                              </td>
                                                              <td width="6"></td>
                                                              <td width="17">
                                                                  <a href="#" style="display: block; border: 0; text-decoration: none; width: 17px;">
                                                                      <img src="twitter.png" width="17" style="display: block;" vspace="0" hspace="0" border="0" alt="icon">
                                                                  </a>
                                                              </td>
                                                              <td width="6"></td>
                                                              <td width="17">
                                                                  <a href="#" style="display: block; border: 0; text-decoration: none; width: 17px;">
                                                                      <img src="whatsapp.png" width="17" style="display: block;" vspace="0" hspace="0" border="0" alt="icon">
                                                                  </a>
                                                              </td>
                                                              <td width="6"></td>
                                                              <td width="17">
                                                                  <a href="#" style="display: block; border: 0; text-decoration: none; width: 17px;">
                                                                      <img src="youtube.png" width="17" style="display: block;" vspace="0" hspace="0" border="0" alt="icon">
                                                                  </a>
                                                              </td>
                                                              <td width="6"></td>
                                                              <td width="17">
                                                                  <a href="#" style="display: block; border: 0; text-decoration: none; width: 17px;">
                                                                      <img src="instagram.png" width="17" style="display: block;" vspace="0" hspace="0" border="0" alt="icon">
                                                                  </a>
                                                              </td>
                                                          </tr>
                                                      </table>
